/* =====================================================
   PMV GOAT FARM – UPGRADED JAVASCRIPT
   ===================================================== */
...
const translations = {
  ...
  ta: {
    ...
    hero_desc: "எட்டயபுரம் மயிலம்பாடி & ஆந்திர நெல்லு ஜுடுபி இனங்களில் நிபுணத்துவம் — அன்புடன் வளர்க்கப்பட்டு, நம்பகமாக விற்கப்படுகிறது.",
    hero_btn1: "இனங்களை காண்க", hero_btn2: "இப்போதே விசாரிக்க",
    scroll_down: "▼ கீழே உருட்டுக",
    stat1: "விற்கப்பட்ட ஆடுகள்", stat2: "வருட அனுபவம்", stat3: "உயரிய இனங்கள்", stat4: "மகிழ்ச்சியான வாடிக்கையாளர்கள்",
    about_label: "நாங்கள் யார்",
    about_title: "நம்பிக்கை & தரத்தின் மீது கட்டப்பட்ட குடும்ப பண்ணை",
    about_badge: "100% நம்பகமான பண்ணை",
    ...
    breed1_desc: "சிறந்த இறைச்சி தரம் மற்றும் உள்ளூர் காலநிலை நிலைமைகளுக்கு அனுகூலத்திற்கு அறியப்பட்ட ஒரு வலிமையான, தேசிய இனம்.",
    ...
    breed2_desc: "அதன் சிறந்த வளர்ச்சி விகிதம், பெரிய உடல் கட்டமைப்பு மற்றும் விதிவிலக்கான இறைச்சி தரத்திற்கு அங்கீகரிக்கப்பட்ட ஒரு உயரிய ஆந்திர இனம்.",
    ...
    gallery_desc: "PMV ஆட்டு பண்ணையின் ஒரு பார்வை — எங்கள் விலங்குகள், சூழல் மற்றும் மகிழ்ச்சியான வாடிக்கையாளர்கள்.",
    testimonials_label: "வாடிக்கையாளர் மதிப்புரைகள்", testimonials_title: "எங்கள் வாங்குபவர்கள் என்ன சொல்கிறார்கள்",
    test1_text: "\"சிறந்த தரமான ஆடுகள்! நான் வாங்கிய மயிலம்பாடி இனம் ஆரோக்கியமாகவும் நன்றாக வளர்கிறது. PMV ஆட்டு பண்ணையில் மிகவும் திருப்தி.\"",
    test2_text: "\"மிகவும் நேர்மையான மற்றும் வெளிப்படையான கொடுக்கல் வாங்கல். ஆடுகள் விவரிக்கப்பட்டபடியே இருந்தன. நிச்சயமாக மீண்டும் PMV பண்ணையிலிருந்து வாங்குவேன்.\"",
    test3_text: "\"ஆந்திர நெல்லு ஜுடுபி ஆடுகள் அற்புதமானவை – வேகமாக வளர்கின்றன மற்றும் சிறந்த ஆரோக்கியத்தில் உள்ளன. PMV ஆட்டு பண்ணைக்கு நன்றி!\"",
    contact_label: "எங்களை அணுகுங்கள்", contact_title: "தொடர்பு கொள்ளுங்கள்",
    contact_intro: "ஆடுகள் வாங்க விரும்புகிறீர்களா அல்லது மேலும் அறிய விரும்புகிறீர்களா? நாங்கள் உங்களிடமிருந்து கேட்க விரும்புகிறோம்.",
    ...
    form_success: "✅ உங்கள் விசாரணை அனுப்பப்பட்டது! விரைவில் தொடர்பு கொள்கிறோம்.",
  ...
  te: {
    ...
    hero_desc: "ఎట్టయపురం మయిలంబాడి & ఆంధ్ర నెల్లు జుడుపి జాతులలో నిపుణత — శ్రద్ధతో పెంచబడి, విశ్వాసంతో విక్రయించబడుతుంది.",
    hero_btn1: "మా జాతులు చూడండి", hero_btn2: "ఇప్పుడే విచారించండి",
    ...
    about_label: "మేము ఎవరు",
    about_title: "విశ్వాసం & నాణ్యతపై నిర్మించిన కుటుంబ పొలం",
    about_badge: "100% విశ్వసనీయ పొలం",
    ...
    breed1_desc: "అద్భుతమైన మాంసం నాణ్యత మరియు స్థానిక వాతావరణ పరిస్థితులకు అనుకూలత కోసం తెలిసిన దృఢమైన, స్వదేశీ జాతి.",
    ...
    breed2_desc: "దాని అత్యుత్తమ వృద్ధి రేటు, పెద్ద శరీర నిర్మాణం మరియు అసాధారణ మాంసం నాణ్యతకు గుర్తింపు పొందిన ప్రీమియం ఆంధ్ర జాతి.",
    ...
    why1_h: "పూర్తిగా వ్యాక్సినేట్ చేయబడింది", why1_p: "అన్ని మేకలు అమ్మకానికి ముందు వ్యాక్సినేట్ చేయబడి ఆరోగ్య సర్టిఫికేట్ పొందుతాయి.",
    why2_h: "సహజ ఆహారం", why2_p: "అనుకూల ఆరోగ్యం కోసం సహజ మేత మరియు పోషకాహారంపై పెంచబడతాయి.",
    why3_h: "నిజాయితీ ధర", why3_p: "దాచిన చార్జీలు లేని న్యాయమైన, పారదర్శకమైన ధర.",
    why4_h: "రవాణా మద్దతు", why4_p: "మీరు కొనుగోలు చేసిన మేకలను సురక్షితంగా రవాణా చేయడానికి సహాయం చేస్తాం.",
    why5_h: "అమ్మకం తర్వాత మద్దతు", why5_p: "మీ జంతువులను సంరక్షించడంలో సహాయం చేయడానికి కొనుగోలు తర్వాత సంప్రదింపులో ఉంటాం.",
    why6_h: "విశ్వసనీయ ప్రతిష్ఠ", why6_p: "తమిళనాడు మరియు పొరుగు రాష్ట్రాలలో 200 మంది కంటే ఎక్కువ సంతోషకరమైన కస్టమర్లు.",
    gallery_label: "మా పొలం", gallery_title: "ఫోటో గ్యాలరీ",
    gallery_desc: "PMV మేక పొలంలో ఒక క్షణం — మా జంతువులు, వాతావరణం మరియు సంతోషకరమైన కస్టమర్లు.",
    ...
    test2_text: "\"చాలా నిజాయితీగా మరియు పారదర్శకంగా వ్యవహరించారు. మేకలు వివరించినట్లే ఉన్నాయి.\"",
    test3_text: "\"ఆంధ్ర నెల్లు జుడుపి మేకలు అద్భుతంగా ఉన్నాయి – వేగంగా పెరుగుతాయి. PMV మేక పొలానికి ధన్యవాదాలు!\"",
    contact_label: "మమ్మల్ని చేరుకోండి", contact_title: "సంప్రదించండి",
    contact_intro: "మేకలు కొనుగోలు చేయాలనుకుంటున్నారా లేదా మరింత తెలుసుకోవాలనుకుంటున్నారా?",
    ...
    form_success: "✅ మీ విచారణ పంపబడింది! త్వరలో సంప్రదిస్తాం.",
...
function setLang(lang) {
  ...
  document.querySelectorAll('.lang-btn').forEach(btn => {
    ...
    if (matchArr.some(m => text.toLowerCase().includes(m.toLowerCase()))) {
...
let gallery = [
  { src: null, caption: 'Mayilambadi Breed', category: 'Goats' },
  { src: null, caption: 'Farm Environment', category: 'Farm' },
  { src: null, caption: 'Happy Customers', category: 'Customers' },
  { src: null, caption: 'Andhra Nellu Jodipi', category: 'Goats' },
  { src: null, caption: 'Natural Pasture', category: 'Farm' },
  { src: null, caption: 'Our Goat Herd', category: 'Goats' },
];
let activeFilter = 'All';

function loadGallery() {
  try {
    const saved = localStorage.getItem('pmv_gallery');
...
function saveGallery() {
  try { localStorage.setItem('pmv_gallery', JSON.stringify(gallery)); } catch(e) {}
}
...
function renderGallery() {
  ...
  filtered.forEach((item, i) => {
    ...
    div.setAttribute('tabindex', item.src ? '0' : '-1');

    if (item.src) {
      div.innerHTML =
        '<img src="' + item.src + '" alt="' + (item.caption || 'PMV Farm photo') + '" loading="lazy"/>' +
  ...
  setTimeout(() => {
    document.querySelectorAll('.gallery-item.reveal').forEach(el => el.classList.add('visible'));
  }, 50);
}
...
function renderAdminList() {
  ...
  gallery.forEach((item, i) => {
    ...
    const thumbHtml = item.src
      ? '<img class="admin-thumb" src="' + item.src + '" alt=""/>'
    ...
    div.innerHTML = thumbHtml +
      '<div class="admin-item-info"><div class="admin-item-name">' + (item.caption || 'Photo ' + (i+1)) + '</div><div class="admin-item-cat">' + (item.category || 'Farm') + '</div></div>' +
    ...
    div.querySelector('.admin-edit-btn').addEventListener('click', () => adminEditPhoto(i));
    div.querySelector('.admin-del-btn').addEventListener('click', () => adminDeletePhoto(i));
...
function adminAddPhoto() {
  ...
  function doAdd(src) {
    gallery.push({ src: src || null, caption: caption || 'PMV Farm Photo', category });
    saveGallery();
    renderGallery();
    renderAdminList();
    urlInput.value = '';
...
function adminEditPhoto(idx) {
  currentEditIndex = idx;
  const item = gallery[idx];
  const modal = document.getElementById('adminEditModal');
  
  // Populate modal with current values
  const noImgSvg = 'data:image/svg+xml,%3Csvg width="200" height="120" xmlns="http://www.w3.org/2000/svg"%3E%3Crect width="200" height="120" fill="%23333"/%3E%3Ctext x="50%25" y="50%25" text-anchor="middle" dy=".3em" fill="%23888" font-size="14" font-family="Arial"%3ENo image%3C/text%3E%3C/svg%3E';
  const previewEl = document.getElementById('editPhotoPreview');
  previewEl.src = item.src || noImgSvg;
  document.getElementById('editPhotoUrl').value = item.src || '';
  ...
  urlInput.oninput = function() {
    if (this.value.trim()) previewEl.src = this.value.trim();
    else previewEl.src = noImgSvg;
  };
...
function adminSaveEditPhoto() {
  ...
  function doSave(src) {
    gallery[currentEditIndex].src = src || null;
    gallery[currentEditIndex].caption = caption || 'PMV Farm Photo';
    gallery[currentEditIndex].category = category;
    saveGallery();
    renderGallery();
    renderAdminList();
    closeEditModal();
    showAdminToast('✅ Photo saved successfully!');
  }
...
document.addEventListener('DOMContentLoaded', () => {
  document.getElementById('adminEditModal').addEventListener('click', e => {
    if (e.target === document.getElementById('adminEditModal')) closeEditModal();
  });
});

// ===========================
//  DATA STRUCTURES FOR ADMIN CONTENT
// ===========================

// Breeds data
let breedsData = {
  breed1: {
    name: "Ettayapuram Mayilambadi",
    origin: "📍 Tamil Nadu Native Breed",
    description: "A hardy, indigenous breed known for excellent meat quality and adaptability to local climate conditions.",
    features: ["High meat yield", "Drought-resistant", "Easy to maintain", "Strong immune system"],
    image: "images/Breed1.jpeg",
    featured: false
  },
  breed2: {
    name: "Andhra Nellu Jodipi",
    origin: "📍 Andhra Pradesh Heritage Breed",
    description: "A premium Andhra breed recognized for its superior growth rate, larger frame, and exceptional meat quality.",
    features: ["Fast growth rate", "Large body frame", "Superior meat quality", "High market demand"],
    image: "images/goat1.jpeg",
    featured: true
  }
};
...
// Home/Hero data
let homeData = {
  badge: "Est. in Krishnagiri, Tamil Nadu",
  title: "Premium Quality",
  titleSpan: "Goat Farm",
  description: "Specialising in Ettayapuram Mayilambadi & Andhra Nellore Jodipi breeds — raised with care, sold with trust.",
  btn1Text: "View Our Breeds",
  btn2Text: "Enquire Now"
};

// About data
let aboutData = {
  label: "Who We Are",
  title: "A Family Farm Built on Trust & Quality",
  badge: "100% Trusted Farm",
  text1: "PMV Goat Farm is a dedicated goat breeding farm located in Krishnagiri, Tamil Nadu. We specialise in raising healthy, premium-quality Ettayapuram Mayilambadi and Andhra Nellore Jodipi breeds.",
  text2: "Our goats are raised in a clean, natural environment with proper nutrition and veterinary care. We believe in transparent, honest dealings.",
...
let contactData = {
  ...
  phone1: "+91 93619 08550",
  phone2: "+91 86759 04793",
  hours: "Mon–Sun: 8am – 7pm",
  whatsappLink: "https://wa.me/919361908550"
};

// FAQ data
let faqData = [
  {
    question: "Do you deliver goats to other districts or states?",
    answer: "Yes, we assist with transport arrangements across Tamil Nadu and neighbouring states including Andhra Pradesh and Karnataka. Please contact us for transport details."
  },
  {
    question: "Are the goats vaccinated and health-certified?",
    answer: "Yes, absolutely. All goats at PMV Goat Farm are fully vaccinated and health-checked by a veterinarian before sale. We provide documentation on request."
  },
  {
    question: "What is the minimum order quantity?",
    answer: "We sell single goats as well as bulk orders. Whether you need one goat or a large herd, we can accommodate your needs. Please reach out for pricing."
  },
  {
    question: "Can I visit the farm before purchasing?",
    answer: "Absolutely! We welcome farm visits Monday–Sunday, 8am to 7pm. Please call or WhatsApp us in advance to schedule your visit at +91 93619 08550."
  },
  {
    question: "What payment methods do you accept?",
    answer: "We accept cash, bank transfer (NEFT/RTGS), and UPI payments. Our pricing is fully transparent with no hidden charges."
  }
];
...
function loadAllAdminData() {
  try {
    const home = localStorage.getItem('pmv_home');
    if (home) homeData = JSON.parse(home);
  } catch(e) {}

  try {
    const breeds = localStorage.getItem('pmv_breeds');
    if (breeds) breedsData = JSON.parse(breeds);
  } catch(e) {}
  
  try {
    const about = localStorage.getItem('pmv_about');
    if (about) aboutData = JSON.parse(about);
  } catch(e) {}
  
  try {
    const contact = localStorage.getItem('pmv_contact');
    if (contact) contactData = JSON.parse(contact);
  } catch(e) {}
  
  try {
    const faq = localStorage.getItem('pmv_faq');
    if (faq) faqData = JSON.parse(faq);
  } catch(e) {}
}

// Save all data to localStorage
function saveAllAdminData() {
  try { localStorage.setItem('pmv_home', JSON.stringify(homeData)); } catch(e) {}
  try { localStorage.setItem('pmv_breeds', JSON.stringify(breedsData)); } catch(e) {}
  try { localStorage.setItem('pmv_about', JSON.stringify(aboutData)); } catch(e) {}
  try { localStorage.setItem('pmv_contact', JSON.stringify(contactData)); } catch(e) {}
  try { localStorage.setItem('pmv_faq', JSON.stringify(faqData)); } catch(e) {}
}
...
// ===========================
//  ADMIN FUNCTIONS - HOME
// ===========================
function adminEditHome() {
  const modal = document.getElementById('adminHomeModal');
...
function adminSaveHome() {
  ...
  if (!badge || !title || !titleSpan || !description || !btn1Text || !btn2Text) {
...
function closeAdminHomeModal() {
  document.getElementById('adminHomeModal').style.display = 'none';
}
...
function renderHomeSection() {
  ...
  // Update hero title and title span
  const heroTitleElements = document.querySelectorAll('.hero-title');
  if (heroTitleElements[0]) {
    heroTitleElements[0].innerHTML = `${homeData.title}<br/><span>${homeData.titleSpan}</span>`;
  }
...
function adminRenderBreeds() {
  ...
  Object.keys(breedsData).forEach(key => {
    const breed = breedsData[key];
    const div = document.createElement('div');
    div.className = 'admin-breed-item';
    div.innerHTML = `
      <div class="admin-breed-info">
        <img src="${breed.image}" alt="Breed" style="width:60px;height:60px;object-fit:cover;border-radius:8px;margin-right:12px"/>
        <div>
          <div class="admin-breed-name">${breed.name}</div>
          <div class="admin-breed-origin">${breed.origin}</div>
          <div style="font-size:12px;color:#aaa">${breed.features.length} features</div>
        </div>
      </div>
      <div class="admin-item-actions">
        <button class="admin-edit-btn" onclick="adminEditBreed('${key}')">✏️ Edit</button>
        <button class="admin-del-btn" onclick="adminDeleteBreed('${key}')">🗑️ Delete</button>
      </div>
    `;
    container.appendChild(div);
  });
...
function adminEditBreed(key) {
  const breed = breedsData[key];
  const modal = document.getElementById('adminBreedModal');
  document.getElementById('breedKey').value = key;
  ...
  document.getElementById('breedImage').value = breed.image;
  document.getElementById('breedFeaturesText').value = breed.features.join('\n');
  document.getElementById('breedFeatured').checked = breed.featured;
  modal.style.display = 'block';
}

function adminAddNewBreed() {
  const key = 'breed' + (Object.keys(breedsData).length + 1);
  const modal = document.getElementById('adminBreedModal');
  document.getElementById('breedKey').value = '';
  document.getElementById('breedName').value = '';
  document.getElementById('breedOrigin').value = '';
  document.getElementById('breedDesc').value = '';
  document.getElementById('breedImage').value = '';
  document.getElementById('breedFeaturesText').value = '';
  document.getElementById('breedFeatured').checked = false;
  modal.style.display = 'block';
}

function adminSaveBreed() {
  const key = document.getElementById('breedKey').value || 'breed' + (Object.keys(breedsData).length + 1);
  ...
  const image = document.getElementById('breedImage').value.trim();
  ...
  breedsData[key] = { name, origin, description: desc, image, featured, features };
  saveAllAdminData();
  renderBreedCards();
  adminRenderBreeds();
...
function adminDeleteBreed(key) {
  if (confirm('Delete this breed? This cannot be undone.')) {
    delete breedsData[key];
    saveAllAdminData();
    renderBreedCards();
    adminRenderBreeds();
  }
...
function closeAdminBreedModal() {
  document.getElementById('adminBreedModal').style.display = 'none';
}
...
function renderBreedCards() {
  ...
  Object.values(breedsData).forEach(breed => {
    ...
    const badgeHtml = breed.featured ? '<div class="breed-badge-tag">Popular Choice</div>' : '';
    article.innerHTML = `
      ${badgeHtml}
      <div class="breed-icon">
        <img src="${breed.image}" alt="${breed.name} goat" style="width:130px;height:130px;object-fit:cover;border-radius:50%;border:3px solid var(--green-light);"/>
      </div>
      <h3>${breed.name}</h3>
      <p class="breed-origin">${breed.origin}</p>
      <p class="breed-desc">${breed.description}</p>
      <ul class="breed-features">
        ${breed.features.map(f => `<li>${f}</li>`).join('')}
      </ul>
      <div class="breed-ctas">
        <a href="#contact" class="btn btn-primary breed-btn">Enquire About This Breed</a>
...
// ===========================
//  ADMIN FUNCTIONS - ABOUT
// ===========================
function adminEditAbout() {
  const modal = document.getElementById('adminAboutModal');
...
function adminSaveAbout() {
  ...
  saveAllAdminData();
  renderAboutSection();
  closeAdminAboutModal();
  alert('About section updated successfully!');
}

function closeAdminAboutModal() {
  document.getElementById('adminAboutModal').style.display = 'none';
}
...
function renderAboutSection() {
  ...
  if (listContainer) {
    listContainer.innerHTML = aboutData.listItems.map(item => `<li>${item}</li>`).join('');
  }
}

// ===========================
//  ADMIN FUNCTIONS - CONTACT
// ===========================
...
function renderContactSection() {
  // Update location
  const locationItem = document.querySelector('.contact-item:has(+ .contact-item) p');
  if (locationItem) locationItem.textContent = contactData.location;
  
  // Update phones
  const phones = document.querySelectorAll('.contact-item a[href^="tel:"]');
  if (phones[0]) {
    phones[0].href = 'tel:' + contactData.phone1.replace(/\s/g, '');
    phones[0].textContent = contactData.phone1;
  }
  if (phones[1]) {
    phones[1].href = 'tel:' + contactData.phone2.replace(/\s/g, '');
    phones[1].textContent = contactData.phone2;
  }
  ...
  faqData.forEach((item, idx) => {
    ...
    div.innerHTML = `
      <div class="admin-faq-info">
        ...
        <div class="admin-faq-a" style="font-size:13px;color:#aaa;margin-top:6px">${item.answer.substring(0, 80)}...</div>
      </div>
      <div class="admin-item-actions">
...
function adminSaveFAQ() {
  ...
  if (idx === '') {
    ...
    faqData[parseInt(idx)] = { question, answer };
  }
...
function adminDeleteFAQ(idx) {
  if (confirm('Delete this FAQ item? This cannot be undone.')) {
...
function closeAdminFAQModal() {
  document.getElementById('adminFAQModal').style.display = 'none';
}
...
//  ADMIN PANEL UI
// ===========================
// IMPORTANT: Change this to your own private password!
...
document.querySelectorAll(
  '.breed-card, .why-card, .testimonial-card, .stat-card, .about-grid, .contact-grid, .faq-item'
).forEach(el => {
...
document.getElementById('contactForm').addEventListener('submit', async function(e) {
  ...
  if (!name || !phone) {
    alert(currentLang === 'ta'
      ? 'தயவுசெய்து உங்கள் பெயர் மற்றும் தொலைபேசி எண்ணை உள்ளிடுங்கள்.'
  ...
  try {
    ...
    // Send to Formspree
    const response = await fetch('https://formspree.io/f/xbdqaajl', {
      method: 'POST',
      body: formData,
      headers: {
    ...
    alert(currentLang === 'ta'
      ? 'அனுப்புவதில் பிழை ஏற்பட்டது. தயவுசெய்து மீண்டும் முயற்சிக்கவும் அல்லது நேரடியாக எங்களை தொடர்பு கொள்ளவும்.'
      : 'Error sending enquiry. Please try again or contact us directly.');
  } finally {
    // Reset button
